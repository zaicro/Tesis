...
<DIV id="textEditorHtml">
	<input id="textEditor" preset="text" CLASS="mask BgInput" type="text" style="HEIGHT:100%;">
</DIV>
<DIV id="numericEditorHtml">
	<input type="text" id="numericEditor" preset="number" CLASS="mask BgInput" style="HEIGHT:100%">
</DIV>
